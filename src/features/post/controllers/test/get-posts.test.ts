...
describe('Get', () => {
  ...
  describe('posts', () => {
    it('should send correct json response if posts exist in cache', async () => {
      ...
      jest.spyOn(PostCache.prototype, 'getTotalPostNumberInCache').mockResolvedValue(1);
    ...
    it('should send correct json response if posts exist in database', async () => {
      ...
      jest.spyOn(PostCache.prototype, 'getTotalPostNumberInCache').mockResolvedValue(0);
