...
export const ADD_OR_REMOVE_MESSAGE_REACTION: string = 'ADD_OR_REMOVE_MESSAGE_REACTION';
class ChatQueue extends BaseQueue {
  constructor() {
    ...
    this.processJob(ADD_OR_REMOVE_MESSAGE_REACTION, 5, chatWorker.updateMessageReaction);
  }
