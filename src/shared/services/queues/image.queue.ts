...
export const UPDATE_BACKGROUND_IMAGE_IN_BD: string = 'UPDATE_BACKGROUND_IMAGE_IN_BD';
...
class ImageQueue extends BaseQueue {
  constructor() {
    ...
    this.processJob(UPDATE_BACKGROUND_IMAGE_IN_BD, 5, imageWorker.updateBgImageInDB);
